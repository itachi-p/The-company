...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/style.css"> <!-- Added for dashboard's photo sizing -->
            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $user['username'] ?></td>
                    <!-- Only allow to edit own account.　-->
                    <td>
                      <?php
                      if($user['id'] == $_SESSION['id']){
                      ?>

                        <!-- edit button (anker link) -->
